...
TEXT: dict[str, dict[str, str]] = {
    ...
    "business_role_owner": {"en": "Owner", "uz": "Egasi", "tr": "Sahip", "it": "Proprietario", "ru": "Владелец"},
    "business_role_manager": {"en": "Manager", "uz": "Menejer", "tr": "Yönetici", "it": "Responsabile", "ru": "Менеджер"},
    "business_role_accountant": {"en": "Accountant", "uz": "Buxgalter", "tr": "Muhasebeci", "it": "Contabile", "ru": "Бухгалтер"},
    "business_role_cashier": {"en": "Cashier", "uz": "Kassir", "tr": "Kasiyer", "it": "Cassiere", "ru": "Кассир"},
    "business_role_viewer": {"en": "Viewer", "uz": "Kuzatuvchi", "tr": "Görüntüleyici", "it": "Visualizzatore", "ru": "Наблюдатель"},
    "workspace_ready": {
        "en": "ready for future web connection",
        "uz": "kelajakdagi veb ulanishga tayyor",
        "tr": "gelecekteki web bağlantısına hazır",
        "it": "pronto per il futuro collegamento web",
        "ru": "готово к будущему подключению сайта",
    },
    "workspace_pending": {
        "en": "preparing",
        "uz": "tayyorlanmoqda",
